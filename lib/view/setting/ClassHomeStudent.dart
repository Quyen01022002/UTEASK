...
class ClassHomeStudent extends StatefulWidget {
  const ClassHomeStudent({Key? key}) : super(key: key);

  @override
  _ThongKeState createState() => _ThongKeState();
}

class _ThongKeState extends State<ClassHomeStudent> {
  final ClassController classController = Get.put(ClassController());
  @override
  void initState() {
    super.initState();

    classController.loadClassOfMembers();
  }
